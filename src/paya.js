...
class paya extends terminal{
        ...
        if(typeof $ID !== 'undefined') {
            if(typeof terminal !== 'undefined') {
                if($ID(this.#element) instanceof HTMLDivElement) {
                    ...
                    super.create(this.#hexID.titleC, {
                        height       : '100px',
                        width        : this.#attr.width,
                        opacity      : this.#attr.opacity,
                        fgColor      : this.#attr.fgColor,
                        bgColor      : this.#attr.bgColor,
                        tlColor      : this.#attr.tlColor,
                        fontName     : this.#attr.fontName,
                        fontSize     : this.#attr.fontSize,
                        dateOption   : this.#attr.dateOption,
                        typeMode     : this.#attr.typeMode,
                        readOnly     : this.#attr.readOnly
                    });

                    $ID(this.#hexID.titleC).ATTR('style', `
                        position: relative;
                        margin: 0 auto;
                        right: 0px;
                        left: 0px;
                    ...
                    $ERROR('Eelement Not Implemented');
                }
            }
            else {
            ...
            throw Error('Selector Not Implemented');
        } 
    }
     ...
     */
    #hexRGB() {
        if(arguments.length <= 0) { $ERROR('require args'); }

        if(typeof arguments[0] !== 'undefined') if(typeof arguments[0] !== 'string') { $ERROR('arg type mismatch'); }
    ...
    */
    ...
    #random() {
        ...
        if(typeof arguments[0] !== 'undefined') if(typeof arguments[0] !== 'number') { $ERROR('arg type mismatch'); }
    ...
    */
    ...
    #calcCoord(x1, y1, x2, y2, degree) {
        ...
        if(typeof arguments[0] !== 'undefined') if(typeof arguments[0] !== 'number') { $ERROR('arg type mismatch'); }
        if(typeof arguments[1] !== 'undefined') if(typeof arguments[1] !== 'number') { $ERROR('arg type mismatch'); }
        if(typeof arguments[2] !== 'undefined') if(typeof arguments[2] !== 'number') { $ERROR('arg type mismatch'); }
        if(typeof arguments[3] !== 'undefined') if(typeof arguments[3] !== 'number') { $ERROR('arg type mismatch'); }
    ...
    #create() {
        let cosmos          = $CREATE('div'),
            cosmos_title    = $CREATE('div'),
            cosmos_body     = $CREATE('div'),            
            cosmos_style    = $CREATE('style'),
            detail          = $CREATE('div'),
            detail_title    = $CREATE('div'),
            detail_body     = $CREATE('div'),
            terminal        = $CREATE('div');
        ...
        cosmos_style.innerHTML = `
            ...
            #${this.#hexID.textC} { scrollbar-width: thin; scrollbar-color: rgba(129, 129, 129, 0.79) rgba(66, 66, 66, 0.3);}
            #${this.#element}::selection { background-color: rgba(152, 152, 152, 0.79); }`;
        document.head.appendChild(cosmos_style);

        $OBJ(cosmos).ATTR('style', `
            position: relative;
            margin: 0 auto;
            right: 0px;
            left: 0px;
        ...
        `);
        $OBJ(cosmos_title).ATTR('id', this.#hexID.title);
        $OBJ(cosmos_title).TEXT(this.#attr.title);

        $OBJ(cosmos_body).ATTR('style', `
            width: 100%;
        ...
        $OBJ(detail_title).ATTR('style', `
            ...
            -webkit-user-select: none;
        `);
        $OBJ(detail_title).ATTR('id', this.#hexID.titleD);
        $OBJ(detail_title).TEXT('Data');

        $OBJ(detail_body).ATTR('style', `
            width: 100%;
            ...
            z-index: 1;
        `);
        $OBJ(detail_body).ATTR('id', this.#hexID.bodyD);

        detail.append(detail_title, detail_body);
        $ID(this.#element).append(detail);

        for(let loop = 0; loop <= 24; loop++)
        {
            $ID(this.#hexID.bodyD).innerHTML += `<div id="data${loop}" style="display: inline-block; width: 20%; text-align: center; font-size: 10px;"></div>`;
        }
       
        $OBJ(terminal).ATTR('id', this.#hexID.titleC);
    ...
    */
    ...
    #defaultCommand() {
        ...
        this.addCommand('get', function () {
            ...
            if(typeof arguments[0] !== 'undefined') if(typeof arguments[0] !== 'object') { $ERROR('arg type mismatch'); }

            if(typeof arguments[0][0] !== 'undefined') if(typeof arguments[0][0] !== 'string') { $ERROR('arg type mismatch'); }
            if(typeof arguments[0][1] !== 'undefined') if(typeof arguments[0][1] !== 'string') { $ERROR('arg type mismatch'); }
            if(typeof arguments[0][2] !== 'undefined') if(typeof arguments[0][2] !== 'string') { $ERROR('arg type mismatch'); }
            if(typeof arguments[0][3] !== 'undefined') if(typeof arguments[0][3] !== 'string') { $ERROR('arg type mismatch'); }
